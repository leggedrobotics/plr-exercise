...
_Note:_ if you want this to apply only to your current project (not all your vscode projects), open workspace settings instead.
...
```
    ...
    "black-formatter.args": [
        "--line-length=120" // Or anything you prefer.
    ],
```
